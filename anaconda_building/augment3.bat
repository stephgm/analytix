...
:: for unit testing
:: c:\anaconda3-2020.02b2\Scripts\conda.exe install -y pyculib
:: exit
c:\anaconda3-2020.02b2\Scripts\conda.exe config --set ssl_verify false
c:\anaconda3-2020.02b2\Scripts\conda.exe update -n base conda -y
...
c:\anaconda3-2020.02b2\python -m pip --trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org install msgpack argparse urwid
:: what actually works
c:\anaconda3-2020.02b2\python -m pip --trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org install construct hexdump pypcapfile python-pcapng avro python-pptx pyinstaller removestar flynt ipytree
c:\anaconda3-2020.02b2\python -m pip --trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org install pyopencl pycuda
rem dont work
rem c:\anaconda3-2020.02b2\python -m pip --trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org install altair altair-widgets seaborn-altair altair-recipes yerkes gencharts
:: John Weier's addtitions
c:\anaconda3-2020.02b2\python -m pip --trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org install actdiag blockdiag nwdiag seqdiag arrow colorcet dill pathlib terminal-table tabulate removestar flynt pdfminer3k
c:\anaconda3-2020.02b2\Scripts\conda.exe clean -a -y
c:\anaconda3-2020.02b2\python.exe c:\tools\src\feature_download.py --output \anaconda3-2020.02b2\Lib\site-packages\cartopy\data physical
c:\anaconda3-2020.02b2\python.exe c:\tools\src\feature_download.py --output \anaconda3-2020.02b2\Lib\site-packages\cartopy\data physical
